...
// ==============================================================
#ifndef __ov5640_GaussianBlhbi__HH__
#define __ov5640_GaussianBlhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ov5640_GaussianBlhbi) {
    ...
    SC_CTOR(ov5640_GaussianBlhbi):  simcore_mac_0_U ("simcore_mac_0_U") {
