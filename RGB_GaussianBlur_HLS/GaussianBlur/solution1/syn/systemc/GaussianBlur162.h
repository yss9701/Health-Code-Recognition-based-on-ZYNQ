...
#ifndef _GaussianBlur162_HH_
#define _GaussianBlur162_HH_
...
struct GaussianBlur162 : public sc_module {
    ...
    // Module declarations
    GaussianBlur162(sc_module_name name);
    SC_HAS_PROCESS(GaussianBlur162);
